  ...
  <header class="w-full border-b border-gray-200 sticky top-0 bg-white z-20">
      ...
      <nav class="flex items-center flex-wrap justify-center gap-6 text-sm font-medium text-gray-700">
        <div class="relative">
          <button @click="toggleDropdown('product')"
            class="hover:text-sky-700 flex items-center gap-1 cursor-pointer">Product
            <svg v-if="activeDropdown === 'product'" id='Arrow_Button_Up_2_24' width='12' height='12'
            ...
            <svg v-else id='Arrow_Button_Down_2_24' width='12' height='12' viewBox='0 0 24 24'
    ...
    <a href=" #" class="hover:text-sky-700"">Pricing</a>
      ...
      <button @click="toggleDropdown('resource')"
        ...
        <svg v-if="activeDropdown === 'resource'" id='Arrow_Button_Up_2_24' width='12' height='12' viewBox='0 0 24 24'
          xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink'>
          <rect width='24' height='24' stroke='none' fill='#000000' opacity='0' />
      ...
      <a href=" #" class="text-gray-600 hover:text-sky-700"">Sign In</a>
        ...
        <div class="font-semibold">(844) 448-0110</div>
        <div class="text-gray-400">(9am to 6pm CST, Mon-Sat)</div>
        </div>
        </nav>
            ...
            <svg id='Interface_User_Circle_20' width='26' height='26' viewBox='0 0 20 20'
              ...
              <g transform="matrix(1.14 0 0 1.14 10 10)">
                <g style="">
                  ...
                  <g transform="matrix(1 0 0 1 0 3.7)">
                    <path
                      style="stroke: rgb(0,0,0); stroke-width: 1; stroke-dasharray: none; stroke-linecap: round; stroke-dashoffset: 0; stroke-linejoin: round; stroke-miterlimit: 4; fill: none; fill-rule: nonzero; opacity: 1;"
                      transform=" translate(-7, -10.7)"
                      d="M 2.73 11.9 C 3.6375053570024782 10.410379037451563 5.255713158608387 9.501365026289083 7 9.501365026289083 C 8.744286841391611 9.501365026289083 10.362494642997518 10.410379037451563 11.269999999999998 11.899999999999999"
                      stroke-linecap="round" />
                  </g>
